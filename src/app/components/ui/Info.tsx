      ...
      <div className="w-full lg:w-150 xl:w-200">
        ...
        {pathname === '/about' && (
            ...
            <div className="flex items-center gap-3">
                <Link href={'https://www.linkedin.com/in/youturkey11/'} target='_blank' className="hover:scale-110 transition-all">
                    <FaLinkedin size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://web.facebook.com/ywsf.altrky.179788'} target='_blank' className="hover:scale-110 transition-all">
                    <FaFacebookSquare size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://www.youtube.com/channel/UCvLviX2Q0ujSHap3mn4q8-A'} target='_blank' className="hover:scale-110 transition-all">
                    <IoLogoYoutube size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://www.behance.net/YouTurkey11'} target='_blank' className="hover:scale-110 transition-all">
                    <FaBehanceSquare size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://github.com/YoussefTurkey'} target='_blank' className="hover:scale-110 transition-all">
                    <FaGithubSquare size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://www.tiktok.com/@youturkey11'} target='_blank' className="hover:scale-110 transition-all">
                    <AiFillTikTok size={30} color="#b2b2b2" />
                </Link>
                <Link href={'https://www.instagram.com/youturkey11/'} target='_blank' className="hover:scale-110 transition-all">

...
const HeroSection = () => {
  ...
  return (
    <div className="w-full relative">
      <div
        className="absolute inset-0 -z-10 [background-image:radial-gradient(circle,hsl(var(--foreground)/30%)_1.5px,transparent_1.5px)] [background-size:30px_30px] [background-position:0_0]"/>

  ...
  return (
    <footer className="container mx-auto px-10 xl:px-0 py-5">
      ...
      <div className="flex flex-col md:flex-row items-start gap-5 my-10 sm:my-20">
        ...
        <Btns style="w-full sm:w-[50%] lg:w-[30%] py-5 text-xl sm:text-2xl lg:text-3xl border border-[hsl(var(--secondary))] bg-transparent hover:bg-[hsl(var(--secondary))] hover:text-white flex items-center justify-center gap-2">
